...
int cpuidentif::intelcpu(void) {
    ...
    signature = eax;
    printf("Type - ");
    printf(ASLSTRINGCPUID.IntToString(type));
    printf("\n");
    switch(type) {
        case 0:
        printf("Original OEM");
    ...
    printf("\n");
    printf("Family - ");
    printf(ASLSTRINGCPUID.IntToString(family));
    printf("\n");
    switch(family) {
        case 3:
        printf("i386");
    ...
    if(family == 15) {
        ...
        printf(ASLSTRINGCPUID.IntToString(extended_family));
        printf("\n");
    }
    printf("Model - ");
    printf(ASLSTRINGCPUID.IntToString(model));
    printf("\n");
    switch(family) {
        case 3:
        break;
    ...
    if(max_eax >= 0x80000004) {
        ...
        printf("Brand - ");
        printf(ASLSTRINGCPUID.IntToString(brand));
        printf("\n");
        if(brand < 0x18) {
    ...
    printf("Stepping: ");
    printf(ASLSTRINGCPUID.IntToString(stepping));
    printf("Reserved: ");
    printf(ASLSTRINGCPUID.IntToString(reserved));
    printf("\n");
    return 0;
}
